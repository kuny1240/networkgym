...
class ContinuousCQL:
    def __init__(
        ...
        self.critic_1 = FullyConnectedQFunction(state_dim, action_dim, hidden_dim, orthogonal_init, q_n_hidden_layers).to(device)
        self.critic_2 = FullyConnectedQFunction(state_dim, action_dim, hidden_dim,  orthogonal_init, q_n_hidden_layers).to(device)
        self.critic_1_optimizer = torch.optim.Adam(list(self.critic_1.parameters()), qf_lr)
        self.critic_2_optimizer = torch.optim.Adam(list(self.critic_2.parameters()), qf_lr)
    ...
    def learn(self,
        ...
        next_observations = torch.from_numpy(next_observations).float().to(self._device)
